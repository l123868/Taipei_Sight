					...
					<div class="table-wrapper">
						<table>
						 <style type="text/css">
							...
							<tbody>
								<form id="form1" name="form1" method="post" action="manage_do_insert.php">
								<div class="12u$">
									
									<tr><td width='25'><input type="text" name="sight_name" value = ""></td>
									<td width='25'><input type="text" name="ticket_price" value = ""></td>
									<td width='25'><input type="text" name="website" value = ""></td>
									...
									<td width='25'><input type="text" name="location" value = ""></td>
									<td width='25'><input type="text" name="traffic" value = ""></td>
								</div>
							</tbody>
						</table>
